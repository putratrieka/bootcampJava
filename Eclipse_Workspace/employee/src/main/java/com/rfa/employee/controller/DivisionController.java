...
public class DivisionController {
	...
	@ApiOperation(
			value = "API to retrive all division's data ",
	...
	@ApiOperation(
			value = "API to retrive division's data by id",
			notes = "Return data with JSON format",
			tags = "Get Data API"
			)
	...
	@ApiOperation(
			...
			notes = "Add new division data to datebase",
	...
	@ApiOperation(
			...
			notes = "Update division's data based on provide ID and attached data",
			tags = "Data Manipulation Api"
			)
	...
	@ApiOperation(
			...
			notes = "Delete division's data based on provide ID and attached data",
			tags = "Data Manipulation Api"
			)
